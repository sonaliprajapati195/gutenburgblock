 ...
 * @return {boolean} Whether the given block type is allowed to be inserted.
 */
const canInsertBlockType = exports.canInsertBlockType = (0, _rememo.default)(canInsertBlockTypeUnmemoized, (state, blockName, rootClientId) => (0, _utils.getInsertBlockTypeDependants)(state, rootClientId));
 ...
 */
const getInserterItems = exports.getInserterItems = (0, _data.createRegistrySelector)(select => (0, _rememo.default)((state, rootClientId = null) => {
 ...
 */
const getAllowedBlocks = exports.getAllowedBlocks = (0, _data.createRegistrySelector)(select => (0, _rememo.default)((state, rootClientId = null) => {
  if (!rootClientId) {
    return;
  }
 ...
 */
const __experimentalGetReusableBlockTitle = exports.__experimentalGetReusableBlockTitle = (0, _data.createRegistrySelector)(select => (0, _rememo.default)((state, ref) => {

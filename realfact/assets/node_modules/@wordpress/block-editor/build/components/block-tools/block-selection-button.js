...
function BlockSelectionButton({
  ...
  return (0, _react.createElement)("div", {
    ...
    icon: icon,
    showColors: true
  })), (0, _react.createElement)(_components.FlexItem, null, editorMode === 'zoom-out' && !isBlockTemplatePart && (0, _react.createElement)(_blockMover.default, {
    clientIds: [clientId],
    hideDragHandle: true,
  ...
  }), canRemove && editorMode === 'zoom-out' && !isBlockTemplatePart && (0, _react.createElement)(_components.ToolbarButton, {
    icon: _icons.trash,
    label: "Delete",
    onClick: () => {
      removeBlock(clientId);
